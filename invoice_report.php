...
<h3>Invoice Reports:-</h3><hr style="background-color:lightgrey; height:1px;">
<form action="" method="">
...
$sql1 = "SELECT invoices.inv_id, clients.cl_name, invoices.inv_date, invoices.inv_amount FROM invoices INNER JOIN clients ON invoices.cl_id=clients.cl_id ORDER BY inv_date DESC";
...
if ($result->num_rows > 0) {
	...
	<tr class="bigBFun">        
        ...
        <td>Rs. <?php echo $row["inv_amount"] ?></td>        
		
		<td><a href="genInvoice.php?inid=<?php echo $row["inv_id"] ?>" class="btn btn-primary" target="_blank">View</a> </td>
