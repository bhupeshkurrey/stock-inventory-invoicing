<?php
	...
	if(isset($_GET["imsg"])){
		...
		echo "<script>setTimeout(\"location.href = 'new_invoice.php';\",10);</script>";
	}
...
<h3>New Invoice:-</h3><hr style="background-color:lightgrey; height:1px;">
<div class="row">
<div class="col-sm-4">
...
<table class="table table-bordered selector" style="background-color:lightgrey;">
		...
		<table class="table table-bordered table-hover newList">
			...
			<th style="text-align:right;" colspan="5">Invoice Amount</th>
				 <th style="text-align:center;"><p class="total">0</p><input type="text" class="hidden IAmount" name="inv_amount"></th>
			</tfoot>
		</table>
		
	<div class="row">
 <div class="col-sm-12 text-right"><input type="submit" class="btn btn-primary" value="Save Invoice"></div>
 </div>	
